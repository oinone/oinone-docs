...
If the digital staff has already sent you a deployment package, use 'oinone-op-ds-all-full' in the deployment package and the version specified in the deployment package; This article serves as a reference for the deployment process.
:::
### 1. Community Edition
