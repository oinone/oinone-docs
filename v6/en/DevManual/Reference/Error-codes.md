...
| Project Name                            | Section Start | Class Containing Exception Data Dictionary                          |
| --------------------------------------- | :------------ | ------------------------------------------------------------ |
...
| pamirs-connectors-data-tx               | 10015000      | pro.shushi.pamirs.framework.connectors.data.tx.enmu.TxExpEnumerate |
...
## II. Business Error Codes

When defining error codes for business projects, it is recommended to divide different coding segments with reference to functional module planning.

:::info Note

In actual business projects, it is recommended to use error codes above 30000000.
