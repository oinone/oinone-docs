...
继承自 [通用列属性配置](/zh-cn/DevManual/Reference/UserInterface/ViewArchitectures/README.md)，`columnType` 固定为 `checkbox`。
...
继承自 [通用列属性配置](/zh-cn/DevManual/Reference/UserInterface/ViewArchitectures/README.md)，`columnType` 固定为 `radio`。
...
继承自 [通用列属性配置](/zh-cn/DevManual/Reference/UserInterface/ViewArchitectures/README.md)，`columnType` 固定为 `seq`。
...
继承自 [通用列属性配置](/zh-cn/DevManual/Reference/UserInterface/ViewArchitectures/README.md)
...
这两种方式最终渲染的结果是完全相同的，对布局和 DSL 插槽不熟悉的读者可参考：[DSL](/zh-cn/DevManual/Reference/Front-EndFramework/Widget/DSL.md)
