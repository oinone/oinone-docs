...
prev:
  text: Custom Themes
  link: /v6/en/DevManual/OperationGuide/CustomizeThemes/README.md 
---
### 1、app-switch
...
``` typescript
{
    ...
    "dropdown-box-shadow": "-2px 2px 6px 0px rgba(136, 156, 176, 0.2)",
...
``` typescript
{
    ...
    "input-addon-background": "#F7F7F7",
    "input-addon-color": " rgba(0,0,0,0.65)",
    "input-tag-background": "rgba(3,93,255, 0.1)",
    "input-clear-background": "#fff",
    "input-clear-color": "rgba(0,0,0,.25)",
...
``` typescript
{
    ...
    "multi-tabs-active-color": "var(--oio-primary-color)",
    "multi-tabs-active-font-weight": 500,
    "multi-tabs-active-background": "#ffffff",
    "multi-tabs-icon-color": "rgba(0, 0, 0, 0.2)",
    "multi-tabs-hover-background-color": "#f6f6f6",
    "multi-tabs-background-color-inline": "#ffffff",
    ...
    "multi-tabs-background-color-theme1": "#f6f6f6",
    "multi-tabs-background-color-active-theme1": "#ffffff",
    "multi-tabs-border-color-theme1": "#e2e6e9",
    "multi-tabs-background-color-theme1-inline": "#ffffff",
    "multi-tabs-background-color-active-theme1-inline": "rgba(var(--oio-primary-color-rgb), 0.2)",
    "multi-tabs-active-color-active-theme1-inline": "var(--oio-primary-color)",
    "multi-tabs-icon-color-active-theme1-inline": "var(--oio-multi-tabs-icon-color)",
    "multi-tabs-background-color-theme2": "#ffffff",
    "multi-tabs-border-color-theme2": "#e2e6e9",
    "multi-tabs-background-color-theme3": "#f6f6f6",
    "multi-tabs-background-color-active-theme3": "rgba(var(--oio-primary-color-rgb), 0.2)",
    "multi-tabs-active-color-active-theme3": "var(--oio-primary-color)",
    "multi-tabs-icon-color-active-theme3": "var(--oio-multi-tabs-icon-color)",
    "multi-tabs-background-color-theme3-inline": "#ffffff",
    "multi-tabs-background-color-theme4-inline": "#ffffff",
    "multi-tabs-background-color-active-theme4-inline": "rgba(var(--oio-primary-color-rgb), 0.2)",
    "multi-tabs-active-color-active-theme4-inline": "var(--oio-primary-color)",
...
``` typescript
{
    ...
    "pagination-text-color": "var(--oio-text-color-secondary)",
...
``` typescript
{
    ...
    "rich-text-textarea-selected-border-color": "#b4d5ff",
    ...
    "rich-text-toolbar-color-active-bg-color": "var(--oio-primary-color)",
...
``` typescript
{
    ...
    "select-counter-background": "#ffffff",
    "select-counter-color": "rgba(0, 0, 0, 0.25)",
    ...
    "select-dropdown-selected-color": "var(--oio-primary-color)",
    "select-dropdown-color": "var(--oio-text-color-secondary)",
    "select-dropdown-selected": "rgba(var(--oio-primary-color-rgb), 0.1)",
    "select-dropdown-box-shadow": "0 3px 6px -4px rgba(0, 0, 0, 0.12), 0 6px 16px 0 rgba(0, 0, 0, 0.08),0 9px 28px 8px rgba(0, 0, 0, 0.05)",
...
``` typescript
{
    ...
    "table-text-color": "rgba(0, 0, 0, 0.65)",
    "table-title-color": "rgba(0, 0, 0, 0.85)",
    "table-title-font-weight": 500,
    "table-title-sort-icon-size": "11px",
    "table-tr-height": "var(--oio-height-lg)",
    "table-tr-stripe-bg": "#fafafa",
    "table-tr-checked-bg": "rgba(var(--oio-primary-color-rgb), 0.1)",
    "table-tr-hover-bg": "rgba(var(--oio-primary-color-rgb), 0.1)",
    "table-row-border": "rgba(243, 243, 243, 1)",
    "table-row-body-border": "#e8eaec",
    "table-config": {
        "border": "full",
        "stripe": true,
        "isCurrent": true,
