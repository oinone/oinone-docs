...
prev:
  text: 运行程序包方式安装
  link: /v6/zh/InstallOrUpgrade/EnterpriseEdition/package-installation.md
---
...
+  [快速体验：docker-full方式安装](/zh/InstallOrUpgrade/EnterpriseEdition/docker-full-installation.md)
+  [docker-mini方式安装](/zh/InstallOrUpgrade/EnterpriseEdition/docker-mini-installation.md)
...
[后端部署启动常见问题](/zh/DevManual/FAQ/startup-frequently-asked-questions-about-backend-startup.md)