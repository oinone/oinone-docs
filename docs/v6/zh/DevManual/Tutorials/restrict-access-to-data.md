...
在学习这篇文章之前，你首先需要对 Oinone 安全相关内容进行一个初步了解，以便于理解本文所介绍的自定义相关内容。参考：[后端框架 - 安全简介](/zh/DevManual/Tutorials/Back-endFramework/chapter4-a-brief-introduction-to-security.md)
...
参考：与此主题相关的文档可在 “[安全机制](/zh/DevManual/Reference/Back-EndFramework/security-in-oinone.md)” 、“[网关协议 API](/zh/DevManual/Reference/Back-EndFramework/AdvanceAPI/protocol-API.md)” 和 “[请求上下文 API](/zh/DevManual/Reference/Back-EndFramework/AdvanceAPI/request-context-API.md)” 中找到。
...
在大多数场景中，同一个占位符可能用在多个地方，并且可能在一个请求中重复使用。对于占位符值的获取一般我们采用 “线程级别缓存” 进行处理。这一部分没有示例代码，读者可参考 “[请求上下文 API](/zh/DevManual/Reference/Back-EndFramework/AdvanceAPI/request-context-API.md)” 中的 “扩展 PamirsSession” 部分的内容自行实现。
