...
next:
  ...
  link: /v6/zh/DevManual/Tutorials/init-module-data.md
---
...
更多关于卡片组件 API 的内容可参考：[Element](/zh/DevManual/Reference/Front-EndFramework/Widget/element.md)
...
更多关于表达式的内容可参考：[Expression Service](/zh/DevManual/Reference/Front-EndFramework/Services/expression-service.md)
