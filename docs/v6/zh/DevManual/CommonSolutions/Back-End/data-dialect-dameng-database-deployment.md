...
注：更多 YAML 配置请前往 [Module API](/zh/DevManual/Reference/Back-EndFramework/module-API.md) 查阅。

## （一）连接url配置
点击查看官方文档：[DM JDBC 编程指南](https://eco.dameng.com/document/dm/zh/pm/jdbc-rogramming-guide.html)
