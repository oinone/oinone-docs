...
next:
  ...
  link: /v6/zh/DevManual/Reference/Back-EndFramework/AdvanceAPI/protocol-API.md
---
...
让我们先通过之前的教程内容创建一个 `移动端应用（mobile_demo）`。参考：[后端框架 - 新建一个应用](/zh/DevManual/Tutorials/Back-endFramework/chapter2-a-new-application.md)

:::warning 提示：

关于模块化设计的相关内容可参考：[研发范式：模块化设计](/zh/DevManual/R&DParadigm/R&D-paradigm-modular-design.md)
