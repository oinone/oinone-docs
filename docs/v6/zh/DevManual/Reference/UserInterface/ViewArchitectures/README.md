...
prev:
  ...
  link: /v6/zh/DevManual/Reference/Front-EndFramework/Services/translate-service.md
next:
  text: 表格（Table）
  link: /v6/zh/DevManual/Reference/UserInterface/ViewArchitectures/table.md
---
...
更多关于 母版 相关的内容请参考：[Mask](/zh/DevManual/Reference/Front-EndFramework/Widget/mask.md)
...
更多关于 UxRouteButton 相关的内容请参考：[交互 API](/zh/DevManual/Reference/Back-EndFramework/UX-API.md)
