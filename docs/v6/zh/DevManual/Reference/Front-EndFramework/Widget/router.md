...
prev:
  text: Gallery Field
  link: /v6/zh/DevManual/Reference/Front-EndFramework/Widget/Field/gallery-field.md
next:
  text: Vue UI Antd
  link: /v6/zh/DevManual/Reference/Front-EndFramework/OioComponents/vue-UI-antd.md
---
路由组件是 Oinone 路由中的核心组件，与其他组件一样，都是通过 SPI 注册组件的方式实现的，下面将对这一类路由组件的注册以及内置路由组件进行介绍。

更多关于 路由 的内容请参考：[Router Service](/zh/DevManual/Reference/Front-EndFramework/Services/router-service.md)
