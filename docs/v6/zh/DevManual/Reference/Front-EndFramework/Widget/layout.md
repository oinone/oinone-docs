...
关于 **插槽** 相关介绍请参考：[DSL](/zh/DevManual/Reference/Front-EndFramework/Widget/DSL.md)
...
下面是我们在 “[探索前端框架 - 组件](/zh/DevManual/Tutorials/DiscoverTheFront-endFramework/chapter1-widget.md)” 中注册的布局：
