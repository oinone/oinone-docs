...
2. Combine with the UI Designer to use our practice components as custom widgets. Refer to [Custom Widgets with Designer - Field Widgets](/en/DevManual/OperationGuide/combination-of-customized-widget-and-designer.md#08cfd943).