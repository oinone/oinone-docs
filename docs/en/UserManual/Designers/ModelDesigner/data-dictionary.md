...
![](https://oinone-jar.oss-cn-zhangjiakou.aliyuncs.com/welcome-document/en/UserManual/Designers/ModelDesigner/DataDictionary/image-20250626141414514.png)
...
:::
### 2. Operation Method
+ Click "Import Data Dictionary" and select the application
![](https://oinone-jar.oss-cn-zhangjiakou.aliyuncs.com/welcome-document/en/UserManual/Designers/ModelDesigner/DataDictionary/image-20250626141512749.png)
...
![](https://oinone-jar.oss-cn-zhangjiakou.aliyuncs.com/welcome-document/en/UserManual/Designers/ModelDesigner/DataDictionary/image-20250626141618377.png)
...
:::
![](https://oinone-jar.oss-cn-zhangjiakou.aliyuncs.com/welcome-document/en/UserManual/Designers/ModelDesigner/DataDictionary/image-20250626143134170.png)
...
:::
![](https://oinone-jar.oss-cn-zhangjiakou.aliyuncs.com/welcome-document/en/UserManual/Designers/ModelDesigner/DataDictionary/image-20250626143538737.png)
### 2. Operation Method
Click "Add Data Dictionary", select the application/module to add, click "Add" to display the pop-up window, and click "OK" after filling in to successfully create the data dictionary.
![](https://oinone-jar.oss-cn-zhangjiakou.aliyuncs.com/welcome-document/en/UserManual/Designers/ModelDesigner/DataDictionary/image-20250626144057846.png)
:::info Note
...
![](https://oinone-jar.oss-cn-zhangjiakou.aliyuncs.com/welcome-document/en/UserManual/Designers/ModelDesigner/DataDictionary/image-20250626145115188.png)
...
![](https://oinone-jar.oss-cn-zhangjiakou.aliyuncs.com/welcome-document/en/UserManual/Designers/ModelDesigner/DataDictionary/image-20250626145212918.png)
:::
### 2. Operation Method
Click the "View Referenced Information" icon to view the reference relationship  
![](https://oinone-jar.oss-cn-zhangjiakou.aliyuncs.com/welcome-document/en/UserManual/Designers/ModelDesigner/DataDictionary/image-20250626145339495.png)
...
![](https://oinone-jar.oss-cn-zhangjiakou.aliyuncs.com/welcome-document/en/UserManual/Designers/ModelDesigner/DataDictionary/image-20250626145539866.png)
...
![](https://oinone-jar.oss-cn-zhangjiakou.aliyuncs.com/welcome-document/en/UserManual/Designers/ModelDesigner/DataDictionary/image-20250626145629335.png)
