  ...
  <nav class="nav" :class="{ scrolled }" id="mainNav">
    <div class="nav-inner">
      ...
      <div class="nav-links">
        ...
        <a class="nav-link" href="https://doc.oinone.top/" target="_blank" rel="nofollow">{{ $t('nav.community') }}</a>
        <a class="nav-link" href="https://market.oinone.top/" target="_blank" rel="nofollow">{{ $t('nav.market') }}</a>
        <!-- Resources Dropdown -->
        <div class="nav-dropdown-wrap">
