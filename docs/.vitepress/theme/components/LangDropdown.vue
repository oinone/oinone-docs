...
<template>
  ...
  >
    <button class="custom-dropdown-button" @click="toggleDropdown">
      <svg class="icon-translate" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"
           fill="currentColor">
        <path
    ...
    <transition name="fade-slide">
      <div v-show="isOpen" class="custom-dropdown">
        ...
        >
          <span>{{ lang.text }}</span>
          <svg v-if="currentLang === lang.value" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16"
