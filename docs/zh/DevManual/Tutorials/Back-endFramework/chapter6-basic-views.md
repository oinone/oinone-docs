...
参考：与此主题相关的文档可在 “[表格视图](/zh/DevManual/Reference/UserInterface/view-architectures.md)” 中找到。
...
参考：与此主题相关的文档可在 “[表单视图](/zh/DevManual/Reference/UserInterface/view-architectures.md)” 中找到。
