...
next:
  ...
  link: /zh/DevManual/Reference/UserInterface/ViewArchitectures/README.md
---
在 Oinone Kunlun 中，内置了 “翻译” 模块，其配合前端 “埋点” 翻译函数可以实现任何语言的翻译功能。这篇文章将介绍 “翻译” 函数的使用以及其实现细节。

:::warning 提示：

本章内容不涉及 “翻译” 模块的具体操作和使用，仅介绍前端翻译功能和实现细节。需要了解 “翻译” 模块相关操作的内容请参考：[用户手册 - 翻译](/zh/UserManual/StandardModules/translation.md)
