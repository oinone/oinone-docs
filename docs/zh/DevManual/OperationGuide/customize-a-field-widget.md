...
prev:
  ...
  link: /zh/DevManual/Tutorials/debug-tools.md
---
回想一下我们在 “[探索前端框架](/zh/DevManual/Tutorials/DiscoverTheFront-endFramework/chapter1-widget.md)” 章节中创建的组件，无一例外的都使用了一个被命名为 `BaseElementWidget` 的基类，并且它们的使用方式也都不尽相同。为了便于我们回忆之前的内容，下面是之前“计数器”组件的部分代码和它的使用方式。
...
[更多 Oinone 内置组件](/zh/DevManual/Reference/Front-EndFramework/Widget/Field/README.md)
...
更多关于字段组件注册的内容可参考：[Field](/zh/DevManual/Reference/Front-EndFramework/Widget/Field/README.md)
...
更多关于 Oinone 内置标准组件的内容可参考：[Oio Components](/zh/DevManual/Reference/Front-EndFramework/OioComponents/README.md)
...
在这里仅简要说明一下字段组件注册的基础内容，以确保我们在接下来的学习中可以较为容易的理解一些概念。更多组件注册的相关内容可参考：[Field](/zh/DevManual/Reference/Front-EndFramework/Widget/Field/README.md)
...
更多关于内置字段组件的内容请参考：[Field](/zh/DevManual/Reference/Front-EndFramework/Widget/Field/README.md)
...
更多关于表单字段组件的 API 内容可参考：[Form Field](/zh/DevManual/Reference/Front-EndFramework/Widget/Field/form-field.md)
...
更多关于表格字段组件的 API 内容可参考：[Table Field](/zh/DevManual/Reference/Front-EndFramework/Widget/Field/table-field.md)
