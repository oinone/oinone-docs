...
next:
  text: 企业版
  link: /zh/InstallOrUpgrade/EnterpriseEdition.md
---
...
+ 学习如何使用 Oinone 产品：[点击查看用户手册](/zh/UserManual/README.md)
+ 学习如何使用 Oinone 进行业务工程开发：[点击查看研发手册](/zh/DevManual/README.md)
+ 学习如何配置 Oinone 服务（高级）：[点击查看配置指南](/zh/InstallOrUpgrade/setup-oinone-designer.md)
