...
更多关于 GQLBuilder 的使用示例和 API 请参考：[GraphQL Service - GQLBuilder](/zh-cn/DevManual/Reference/Front-EndFramework/Services/graphQL-service.md#一-gqlbuilder)
...
更多关于 GenericFunctionService 的 API 和使用示例请参考：[GraphQL Service - GenericFunctionService](/zh-cn/DevManual/Reference/Front-EndFramework/Services/graphQL-service.md#二-genericfunctionservice)
